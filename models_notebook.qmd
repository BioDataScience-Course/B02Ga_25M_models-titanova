...
Les données de cette étude proviennent du dépot Zenodo de Montaya et al. (2023) [@Montaya2023]. Le logiciel utilisé est R (version 4.4.1) (https://www.r-project.org) (`r R.version.string`) Le jeu de données est légèrement remanié (traitement documenté dans le fichier `R/import_micropop.R`).
