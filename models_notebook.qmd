...
l'analyse des résidus montre que l'étendue des résidus est élevé (0.2) par rapport à celui des valeurs prédites (0.15), on observe aussi une non linéarité du modèle (A). Les résidus présente une non normalité mais la distribution est symétrique (en forme de S) (B). L'analyse des variances montre relativement une homoscédatiscité (C). Plusieurs valeurs extrêmes sont observées, la distance de Cookds est importante pour certains points qui tirent la courbe de part et d'autre d'où l'effet de levier observé (D). D'après cette analyse, le modèle généralisé semble robuste pour modéliser nos données.
