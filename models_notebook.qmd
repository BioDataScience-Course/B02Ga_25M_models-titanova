...
```{r étude et comparaison des modèles}
...
```{r étude et comparaison des modèles}
microp_lm2.1<- lm(data= microp,  chla_fluo ~plast_tot)
chart(microp_lm2)
microp_lm2.2 <- lm(data= microp,  chla_fluo ~plast_tot + I(plast_tot^2))
chart(microp_lm2)
microp_lm2.3<- lm(data= microp,  chla_fluo ~plast_tot + I(plast_tot^2) + I(plast_tot^3))
chart(microp_lm2)
```
...
```{r comparaison des modèles 1 et 2}

AIC(microp_lm4.1, microp_lm4.2)
```


```{r comparaison des modèles 2 et 3}
